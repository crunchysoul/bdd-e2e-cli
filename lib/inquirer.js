  ...
  askProtractor: () => {
    const questions = [
      ...
      },
      {
        name: 'framework',
        type: 'input',
        message: 'Protractor framework',
        default: 'custom',
      },
      {
        name: 'frameworkPath',
        type: 'input',
        message: 'Protractor framework path',
        default: 'TODO',
      },
      {
        name: 'restartBrowserBetweenTests',
        type: 'confirm',
        message: 'restart browser between tests?',
        default: true,
      },
      {
        name: 'ignoreUncaughtExceptions',
        type: 'confirm',
        message: 'Ignore Uncaught Exceptions?',
        default: true,
      },
      {
        name: 'specs',
